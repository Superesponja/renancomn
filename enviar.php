...
// Mudar Aqui o e-mail
$email_envio = "renan@renancomn.com.br"; // E-mail do site (ex: contato@seusite.com)
$email_pass = "A4HAh/(f4M}5Q;*H"; // Senha do e-mail

$site_name = "Renan com N"; // Nome do Site
$site_url = "www.renancomn.com.br"; // URL do Site

$host_smtp = "free.mboxhosting.com"; // HOST SMTP Ex: smtp.domain.com.br
